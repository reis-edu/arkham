...
RSpec.describe Arkham::Core::UseCases::UpdatePatient do
    ...
    context 'when params are invalid' do
      context 'when params are empty' do
        ...
        it 'raises ApiValidationError' do
          expect { use_case.execute(patient_id, empty_params) }.to raise_error(Arkham::Infrastructure::Errors::ApiValidationError)
        end
      end
      ...
      context 'when required fields are missing' do
        ...
        it 'raises ApiValidationError' do
          expect { use_case.execute(patient_id, missing_fields_params) }.to raise_error(Arkham::Infrastructure::Errors::ApiValidationError)
        end
      end
      ...
      context 'when fields have invalid types' do
        ...
        it 'raises ApiValidationError' do
          expect { use_case.execute(patient_id, invalid_types_params) }.to raise_error(Arkham::Infrastructure::Errors::ApiValidationError)
        end
      end
      ...
      context 'when fields have invalid values' do
        ...
        it 'raises ApiValidationError' do
          expect { use_case.execute(patient_id, invalid_values_params) }.to raise_error(Arkham::Infrastructure::Errors::ApiValidationError)
        end
      end
    end
